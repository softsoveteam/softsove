...
export default function LandingPage3Page() {
  return (
    <>
      					...
      					<div className="page-header-inner">
      						...
      						<div className="ph-caption">
      							<div className="ph-caption-inner">
      								...
      								<h1 className="ph-caption-title">Let’s Build<br /> the Brand You<br /> Meant to Build</h1>
      				...
      				<div id="tt-page-content">
      					...
      					<div className="tt-section">
      						<div className="tt-section-inner">
      							...
      							<div className="tt-portfolio-carousel tt-pci-boxed tt-pci-tilted tt-anim-fadeinup" data-loop="true" data-speed="900" data-simulate-touch="true" data-pagination-type="bullets">
      					...
      					<div className="tt-section no-padding-bottom">
      						<div className="tt-section-inner tt-wrap">
      							...
      							<div className="tt-heading tt-heading-center tt-heading-lg">
      								...
      								<p className="max-width-600 tt-anim-lines">From strategy to execution, we blend design thinking with digital expertise to create work that’s both beautiful and effective.</p>

      								<a href="/about-us" className="tt-btn tt-btn-secondary tt-btn-round tt-magnetic-item tt-anim-fadeinup">
      					...
      					<div className="tt-section">
      						<div className="tt-section-inner">
      							...
      							<div className="tt-accordion tt-acc-xlg tt-acc-counter tt-acc-borders">
      								...
      								<div className="tt-row tt-lg-row-reverse"> 
      									...
      									<div className="tt-col-lg-7">
      										...
      										<div className="tt-sticker-scroller">
      											...
      											<div className="tt-testimonials-list tt-tli-lg">
      						...
      						<div className="tt-section-inner tt-wrap">
      							...
      							<div className="tt-heading tt-heading-xxlg tt-heading-center">
      								...
      								<h2 className="tt-heading-title">
      									<a href="/lets-get-weird" className="tt-anim-characters" data-cursor="Contact">Time to Make Boring Illegal</a> 
      								</h2>
