...
export default function PortfolioScrollingTiltedPage() {
  return (
    <>
      <div id="page-header" className="ph-full ph-full-m ph-center ph-cap-xxxlg ph-image-parallax ph-caption-parallax">
      					...
      					<div className="page-header-inner">
      						...
      						<div className="ph-caption">
      							<div className="ph-caption-inner">
      								...
      								<h1 className="ph-caption-title">Projects</h1>
      				...
      				<div id="tt-page-content">
      					...
      					<div className="tt-section padding-bottom-xlg-40">
      						<div className="tt-section-inner">

							
      							<div className="tt-portfolio-scrolling tt-pscr-alter-hover tt-pscr-tilted tt-pscr-tilted-m" data-scroll-speed="300">

								 
      								<a href="/single-project-1" className="tt-pscr-item tt-pscri-reverse-color tt-pscri-reverse-color-m tt-anim-fadeinup" data-cursor="View<br>Project">
      								...
      								<a href="/single-project-2" className="tt-pscr-item tt-pscri-reverse-color-m tt-anim-fadeinup" data-cursor="View<br>Project">
      									<div className="tt-pscr-item-inner">
      										<div className="tt-pscr-item-content">
      								...
      								<a href="/single-project-3" className="tt-pscr-item tt-pscri-reverse-color tt-pscri-reverse-color-m tt-anim-fadeinup" data-cursor="View<br>Project">
      									<div className="tt-pscr-item-inner">
      										<div className="tt-pscr-item-content">
      								...
      								<a href="/single-project-4" className="tt-pscr-item tt-pscri-reverse-color-m tt-anim-fadeinup" data-cursor="View<br>Project">
      									<div className="tt-pscr-item-inner">
      										<div className="tt-pscr-item-content">
      								...
      								<a href="/single-project-5" className="tt-pscr-item tt-pscri-reverse-color tt-pscri-reverse-color-m tt-anim-fadeinup" data-cursor="View<br>Project">
      									<div className="tt-pscr-item-inner">
      										<div className="tt-pscr-item-content">
      								...
      								<a href="/single-project-6" className="tt-pscr-item tt-pscri-reverse-color-m tt-anim-fadeinup" data-cursor="View<br>Project">
      									<div className="tt-pscr-item-inner">
      										<div className="tt-pscr-item-content">
      											<h2 className="tt-pscr-item-title">The Road</h2>

											
      											<picture className="tt-pscr-item-image">
												
      												<source srcSet="/assets/img/portfolio/800/portfolio-6-800.jpg" media="(max-width: 768px)" />
												
      												<img src="/assets/img/portfolio/400/portfolio-6-400.jpg" loading="lazy" alt="Image" />
      											</picture>
      								...
      								<a href="/single-project-7" className="tt-pscr-item tt-pscri-reverse-color tt-pscri-reverse-color-m tt-anim-fadeinup" data-cursor="View<br>Project">
      									<div className="tt-pscr-item-inner">
      										<div className="tt-pscr-item-content">
      											<h2 className="tt-pscr-item-title">Space Break</h2>

											
      											<picture className="tt-pscr-item-image">
												
      												<source srcSet="/assets/img/portfolio/800/portfolio-7-800.jpg" media="(max-width: 768px)" />
												
      												<img src="/assets/img/portfolio/400/portfolio-7-400.jpg" loading="lazy" alt="Image" />
      											</picture>
      								...
      								<a href="/single-project-8" className="tt-pscr-item tt-pscri-reverse-color-m tt-anim-fadeinup" data-cursor="View<br>Project">
      									<div className="tt-pscr-item-inner">
      										<div className="tt-pscr-item-content">
      											<h2 className="tt-pscr-item-title">Cyber Glitch</h2>

											
      											<picture className="tt-pscr-item-image">
												
      												<source srcSet="/assets/img/portfolio/800/portfolio-8-800.jpg" media="(max-width: 768px)" />
												
      												<img src="/assets/img/portfolio/400/portfolio-8-400.jpg" loading="lazy" alt="Image" />
      											</picture>
      								...
      								<a href="/single-project-9" className="tt-pscr-item tt-pscri-reverse-color tt-pscri-reverse-color-m tt-anim-fadeinup" data-cursor="View<br>Project">
      									<div className="tt-pscr-item-inner">
      										<div className="tt-pscr-item-content">
      											<h2 className="tt-pscr-item-title">Mind Landscape</h2>

											
      											<picture className="tt-pscr-item-image">
												
      												<source srcSet="/assets/img/portfolio/800/portfolio-9-800.jpg" media="(max-width: 768px)" />
												
      												<img src="/assets/img/portfolio/400/portfolio-9-400.jpg" loading="lazy" alt="Image" />
      											</picture>
