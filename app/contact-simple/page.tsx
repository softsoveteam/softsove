...
export default function ContactSimplePage() {
  return (
    <>
      <div id="page-header" className="ph-full ph-full-m ph-center ph-cap-lg ph-image-parallax ph-caption-parallax">
      					...
      					<div className="page-header-inner">
      						...
      						<div className="ph-caption">
      							<div className="ph-caption-inner">
      								<h2 className="ph-caption-subtitle">( Contact )</h2>
      								<h1 className="ph-caption-title">Feeling good about<br /> a new project?</h1>
      								<div className="ph-caption-description max-width-700">
      									Is there something exciting on your mind?<br /> Write us and let's talk about it.
      								</div>
      							</div> 
      						</div>  
      					...
      					<div className="tt-section padding-top-40 padding-bottom-120">
      						<div className="tt-section-inner tt-wrap">
      							...
      							<div className="tt-row tt-xl-row-reverse">
      								<div className="tt-col-xl-6 margin-bottom-40">
      									...
      									<div className="tt-heading">
      										...
      										<h2 className="tt-heading-title tt-anim-characters">Get in Touch</h2> 
      									</div>
									

      									<p className="tt-anim-lines">You're just one click away from taking your brand or product from great to incredible. Contact us to share more details about your project.</p>

      									<a href="mailto:company@email.com" className="tt-btn tt-btn-secondary tt-magnetic-item margin-top-20 tt-anim-fadeinup">
      										<span data-hover="Send Us an Email">Send Us an Email</span>
      										<span className="tt-btn-icon"><i className="fa-regular fa-envelope"></i></span>
      									</a>

      								</div> 

      								<div className="tt-col-xl-1">
      								</div> 

      								<div className="tt-col-xl-5">

									
      									<div className="tt-contact-info tt-ci-boxed tt-ci-tilted-1 tt-anim-fadeinup">
      										<div className="tt-contact-info-inner">
											
      											<div className="margin-bottom-40">
      												<h3 className="tt-contact-info-heading">Our Location</h3>
      												<ul className="tt-list">
      													<li>
      														<a href="https://www.google.com.au/maps/place/Envato+Pty+Ltd/@-37.8166193,144.968802,17z/data=!3m1!4b1!4m6!3m5!1s0x6ad65d4c2b349649:0xb6899234e561db11!8m2!3d-37.8166193!4d144.968802!16s%2Fg%2F1tfgjz3b?entry=ttu&g_ep=EgoyMDI1MDQzMC4xIKXMDSoASAFQAw%3D%3D" className="tt-link" target="_blank" rel="noopener">
      											...
      											<div className="margin-bottom-40">
      												<h3 className="tt-contact-info-heading">Contact Details</h3>
      												<ul className="tt-list">
      													<li>
      											...
      											<h3 className="tt-contact-info-heading">Follow Us</h3>

											
      											<div className="tt-social-buttons tt-sbtn-inline tt-sbtn-filled">
      												<ul>
      													<li><a href="https://www.facebook.com/themetorium" className="tt-magnetic-item" target="_blank" rel="noopener"><i className="fa-brands fa-facebook-f"></i></a></li>
      													<li><a href="https://x.com/Themetorium" className="tt-magnetic-item" target="_blank" rel="noopener"><i className="fa-brands fa-x-twitter"></i></a></li>
      													<li><a href="https://dribbble.com/Themetorium" className="tt-magnetic-item" target="_blank" rel="noopener"><i className="fa-brands fa-dribbble"></i></a></li>
