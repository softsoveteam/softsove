...
const TERRAINS: Terrain[] = [
  ...
  },
  {
    ...
    title: "Worked with Indian Government.",
    lead: "We worked with the Indian Government. Gujarat Police, Sansad, and the software that keeps a public brief honest. The state is one chapter. The country is the plot.",
    media: { kind: "gif", src: "/assets/img/terrains/civic.gif" },
    kids: [
      { name: "Indian Government", note: "Worked with Indian Government. Ministries, portals, and systems that serve the country, not a state slogan." },
