...
export default function PortfolioScrollingBoxedTiltedPage() {
  return (
    <>
      					...
      					<div className="tt-section padding-bottom-xlg-140">
      						<div className="tt-section-inner">
      							...
      							<div className="tt-portfolio-scrolling tt-pscr-alter-hover tt-pscr-boxed tt-pscr-tilted tt-pscr-tilted-m" data-scroll-speed="300">
      								...
      								<a href="/single-project-6" className="tt-pscr-item tt-anim-fadeinup" data-cursor="View<br>Project">
      									<div className="tt-pscr-item-inner">
      										<div className="tt-pscr-item-content">
      								...
      								<a href="/single-project-7" className="tt-pscr-item tt-anim-fadeinup" data-cursor="View<br>Project">
      									<div className="tt-pscr-item-inner">
      										<div className="tt-pscr-item-content">
      								...
      								<a href="/single-project-8" className="tt-pscr-item tt-anim-fadeinup" data-cursor="View<br>Project">
      									<div className="tt-pscr-item-inner">
      										<div className="tt-pscr-item-content">
      								...
      								<a href="/single-project-9" className="tt-pscr-item tt-anim-fadeinup" data-cursor="View<br>Project">
      									<div className="tt-pscr-item-inner">
      										<div className="tt-pscr-item-content">
